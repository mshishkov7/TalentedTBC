...
function Talented:UpdatePlayerSpecs()
    ...
    local group = C_SpecializationInfo.GetActiveSpecGroup and C_SpecializationInfo.GetActiveSpecGroup() or
...
function Talented:GetActiveSpec()
    ...
    end -- UpdatePlayerSpecs will use the new API
    return self.alternates[C_SpecializationInfo.GetActiveSpecGroup and C_SpecializationInfo.GetActiveSpecGroup() or
               GetActiveTalentGroup()]
end
